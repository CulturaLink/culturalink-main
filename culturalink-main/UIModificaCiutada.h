...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->PANELModificaCiut->Controls->Add(this->button1);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 7.8F, System::Drawing::FontStyle::Bold));
			this->button1->Location = System::Drawing::Point(347, 473);
			...
			this->pnlTitlesMODCIT->Controls->Add(this->label1);
			...
			this->label1->Text = L"NOM CIUTADA";
			// 
			// lblFormatMODCIT
			// 
