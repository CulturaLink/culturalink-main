...
namespace culturalink_main {
	...
	public:
		PerfilCiutada(void)
		{
			...
			String^ usuariIniciat = usuari->getUsuariNickname();
			//
		}
...
private: System::Void PerfilCiutada_Load(System::Object^ sender, System::EventArgs^ e) {
	UsuariIniciat^ usuari = UsuariIniciat::ObtenerInstancia();
	PassarelaCiutada usuariIniciat = usuari->getUsuari();
	label5->Text = usuariIniciat.getNickname();
	label6->Text = usuariIniciat.getNomComplet();
	label7->Text = usuariIniciat.getCorreu();
	label12->Text = usuariIniciat.getDataNaix();
	label8->Text = usuariIniciat.getDiners()->ToString();
	label9->Text = usuariIniciat.getPunts()->ToString();
