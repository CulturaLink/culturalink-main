...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(256, 105);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(188, 16);
			this->label7->TabIndex = 21;
			this->label7->Text = L"El preu no pot ser negatiu.";
			...
			this->label1->Text = L"Registar Esdeveniment";
			// 
			// button5
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &RegistrarEsdevenimentUI::button3_Click);
			// 
			// button2
			// 
...
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	TxRegistraEsdeveniment tx1(12, nomEsdeveniment, Convert::ToSingle(preu), descripcio, ajuntament);

	try {
		tx1.executar();
		this->Close();
		MessageBox::Show("Esdeveniment Registrat Correctament", "Registrar Esdeveniment");
	}
	catch (int e) {
		if (e == preuNegatiu) {
			// Surt label en vermell que diu "El preu no pot ser negatiu.".
			label7->Visible = true;
		}
	}
}
